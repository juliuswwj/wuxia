...
class wuxia:
    ...
    def load(self):
        ...
        for i in range(3):
            ...
            self.proc = subprocess.Popen([r'C:\Program Files\BlueStacks_nxt\HD-Player.exe'])
            time.sleep(10)
            ...
            while addrs:
                ...
                if isrsc:
                    ...
                    for i in range(4):
                        ...
                        log(f'{i} {h}')
                        if h in ('64ad7dc4453b36b8', '0e8f4a2706026a2e', '406a89b92d02b3b4', '2a6178c2af0c2f1f'):  # 宰杀/拔草寻花/曲院风荷/取水
                            self.click(pos, 3000)
                            break
